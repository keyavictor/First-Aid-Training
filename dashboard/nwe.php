...
<head>
    <title>Lecturers | TimeCraft </title>
    <?php
include '_head.php';
?>
</head>
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fname" class="form-control" id="fname" placeholder="e.g Victor "
                                required>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Last Name:</label>
                            <input type="text" name="lname" class="form-control" id="lname" placeholder="e.g Keya"
                                required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phonenum" class="form-control" id="phonenum"
                                placeholder="e.g 0755621364" required>
                        </div>
                        <div class="form-group">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fname" class="form-control" id="first_name"
                                placeholder="e.g Victor " required>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Last Name:</label>
                            <input type="text" name="lname" class="form-control" id="last_name" placeholder="e.g Keya"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Email:</label>
